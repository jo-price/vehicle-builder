...
class Cli {
    ...
    createMotorbike() {
        inquirer
            ...
            Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [new Wheel(parseInt(answers.frontWheelDiameter), answers.frontWheelBrand), new Wheel(parseInt(answers.rearWheelDiameter), answers.rearWheelBrand)]);
        ...
        inquirer
            ...
            if (vehicleToTow) {
                ...
                if (vehicleToTow instanceof Truck) {
                    console.log('A truck cannot tow another truck. Select another action.');
